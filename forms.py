...
class CreateAccessPairsForm(FlaskForm):
    ...
    access_code_id = SelectField("Select access code", validators=[DataRequired()])
    space_number_id = SelectField("Select space", validators=[DataRequired()])
    submit = SubmitField("Submit")


# add data to approval_status table
class CreateApprovalStatusForm(FlaskForm):
    """
    Approval status form fields
    """

    # status code id is autogenerated
    status_code_name = StringField("Add status code", validators=[DataRequired()])
    submit = SubmitField("Submit")
...
class CreateApproverZonesForm(FlaskForm):
    ...
    # status code id is autogenerated
    building_number = SelectField("Select building", validators=[DataRequired()])
...
class CreateFabricationStatusForm(FlaskForm):
    ...
    # status code id is autogenerated
    fabrication_status = StringField("Add Fabrication Status", validators=[DataRequired()])
    submit = SubmitField("Submit")
